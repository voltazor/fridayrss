 ...
 */
public abstract class BaseMvpPresenterImpl<V extends IBaseMvpView> implements IBasePresenter<V> {
     ...
     */
    @Override
    public <T extends V> void attachView(T view) {
        this.view = view;
        subscriptionList.add(RxNavi.observe((NaviComponent) view, Event.DESTROY).subscribe(new Action1<Void>() {
            @Override
